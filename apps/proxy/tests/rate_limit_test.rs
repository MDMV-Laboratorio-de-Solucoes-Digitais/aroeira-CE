...
mod tests {
    ...
    impl axum::handler::Handler<(), ()> for OkHandler {
        type Future = std::future::Ready<Response<Body>>;

        fn call(self, _req: Request<Body>, _state: ()) -> Self::Future {
            return std::future::ready(StatusCode::OK.into_response());
        }
    }
    ...
    async fn test_per_ip_rate_limiting() {
        ...
        let app = axum::Router::new()
            .route("/test", axum::routing::get(OkHandler))
